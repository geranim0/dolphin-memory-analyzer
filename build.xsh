...
parser = argparse.ArgumentParser(description='build either test or dolphin-memory-analyzer')
parser.add_argument("--build_dir", type=str, choices=['dolphin-memory-analyzer', 'test'], 
